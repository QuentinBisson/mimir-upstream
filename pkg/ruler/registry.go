...
import (
	...
	"github.com/grafana/mimir/pkg/ruler/storage/wal"
)
...
func (n discardingAppender) AppendCTZeroSample(_ storage.SeriesRef, _ labels.Labels, _, _ int64) (storage.SeriesRef, error) {
	return 0, nil
}
