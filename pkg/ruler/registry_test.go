...
func TestRelabelConfigOverridesNilWriteRelabels(t *testing.T) {
	...
	assert.Equal(t, tenantCfg.RemoteWrite[0].WriteRelabelConfigs, reg.config.RemoteWrite.Clients["default"].WriteRelabelConfigs)
...
func (f fakeLimits) ByUserID(userID string) *validation.Limits {
